...
import data_formatters.streamflow
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita','streamflow']
  ...
  def data_csv_path(self):
    csv_map = {
        ...
        'streamflow': 'monthly_streamflow.csv' 
    }
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'streamflow': data_formatters.streamflow.StreamflowFormatter
    }
