...
class DistributedHyperparamOptManager(HyperparamOptManager):
  ...
  def __init__(self,
    ...
    print(serialised_ranges_folder,"serialised_ranges_folder_1")
    self.serialised_ranges_path = os.path.join(serialised_ranges_folder, "ranges_{}.csv".format(search_iterations))
    print(self.serialised_ranges_path, 'self.serialised_ranges_path_1')
  ...
  def get_next_parameters(self):
    ...
    # Always override!
    for en, k in enumerate(self.fixed_params):
